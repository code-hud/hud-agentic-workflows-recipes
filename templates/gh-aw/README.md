...
See the prompt's README for specific instructions, or check the [weekly report example](../../examples/weekly-report-gh-aw/) for a fully worked complex workflow.
...
- [Weekly report](../../examples/weekly-report-gh-aw/) — full multi-phase analysis workflow with Slack output and self-heal.
