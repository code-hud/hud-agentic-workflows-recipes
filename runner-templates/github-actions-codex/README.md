...
Replace the contents of `.github/actions/hud-codex/prompt.txt` with your task prompt. You can grab a ready-made prompt from [`task-recipes/prompts/`](../../task-recipes/prompts/) (e.g. `blast-radius.md`, `dead-code-cleanup.md`) or write your own.
