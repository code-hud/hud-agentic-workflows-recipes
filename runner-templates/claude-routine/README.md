...
**Where to put the prompt:** Open `SKILL.md` and replace the `## Task` section with your task prompt. You can grab a ready-made prompt from [`task-recipes/prompts/`](../../task-recipes/prompts/) (e.g. `rollback-check.md`, `blast-radius.md`) or write your own.
...
**Where to put the prompt:** Open `scheduled-remote/task.md` and replace the `## Task` section with your task prompt. Same source: grab from [`task-recipes/prompts/`](../../task-recipes/prompts/) or write your own.
...
- [Rollback check](../../full-examples/rollback-check-claude-routine/). both variants of a real production rollback gate.
