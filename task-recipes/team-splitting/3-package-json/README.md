...
This is the same pattern used in [`full-examples/weekly-report-gh-aw/`](../../../full-examples/weekly-report-gh-aw/) Phase 0, factored out as a standalone script.
...
- name: Discover teams
  shell: bash
  run: python3 task-recipes/team-splitting/3-package-json/discover.py
...
These slot into the workflow inputs already in [`full-examples/weekly-report-gh-aw/`](../../../full-examples/weekly-report-gh-aw/).
