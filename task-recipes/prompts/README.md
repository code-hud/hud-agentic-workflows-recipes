...
Use-case prompts you can pair with any runner from [`../../runner-templates/`](../../runner-templates/).
...
2. Pick a runner from [`../../runner-templates/`](../../runner-templates/). gh-aw, GitHub Actions, Cursor, or Claude routine.
...
For each prompt here, there's a complete worked example (runner + prompt + install README) under [`../../full-examples/`](../../full-examples/):

| Prompt | Example pairing |
|---|---|
| `blast-radius.md` | [`full-examples/blast-radius-github-actions/`](../../full-examples/blast-radius-github-actions/) |
| `weekly-report/` | [`full-examples/weekly-report-gh-aw/`](../../full-examples/weekly-report-gh-aw/) |
| `dead-code-cleanup.md` | [`full-examples/dead-code-cleanup-cursor/`](../../full-examples/dead-code-cleanup-cursor/) |
| `rollback-check.md` | [`full-examples/rollback-check-claude-routine/`](../../full-examples/rollback-check-claude-routine/) |
