...
- **Different runner?** This example is Cursor-specific. For a runner-agnostic version of the prompt (GitHub Actions, gh-aw, Claude routine), see [`task-recipes/prompts/dead-code-cleanup.md`](../../task-recipes/prompts/dead-code-cleanup.md).
