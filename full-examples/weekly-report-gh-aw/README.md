...
- **Multi-team setup** with one report per team? See [`task-recipes/team-splitting/3-package-json/`](../../task-recipes/team-splitting/3-package-json/) for the team-grouping pattern.
