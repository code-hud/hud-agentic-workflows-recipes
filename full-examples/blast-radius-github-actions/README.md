...
- **Scope by team?** See [`task-recipes/team-splitting/`](../../task-recipes/team-splitting/).
- **Team-only:** gate by GitHub team membership. See [`task-recipes/team-splitting/2-github-teams/`](../../task-recipes/team-splitting/2-github-teams/).
